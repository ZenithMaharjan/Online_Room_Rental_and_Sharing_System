...
export default function Mysearch() {
  ...
  return (
    <div
      className=" flex"
      style={{ width: "100%", height: "550px", backgroundSize: "cover" }}
    >
      <form
      ...
      >
        <input
          className="form-control mt-3 mb-3 fixed mx-1"
          type="search"
          placeholder="Search"
          aria-label="Search"
        />
        ...
        <button
          className="btn btn-outline-success  me-1 mt-3 mb-3 mx-1 "
          type="submit "
