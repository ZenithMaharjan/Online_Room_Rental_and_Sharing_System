...
const Roommate = ({ item }) => {
  ...
  municipalityorvdc =
    municipalityorvdc.charAt(0).toUpperCase() + municipalityorvdc.slice(1);

  return (
    <div>
      <div className="col-lg-6 mt-3">
        <div
          className="card mb-3 bs"
          style={{ minWidth: "500px", maxWidth: "600px", height: "3000x" }}
        >
            ...
            <div className="col-md-8">
              <div className="card-body">
                <h5 className="card-title">
                  {item.type} Required In {item.district}{" "}
                </h5>
                <FontAwesomeIcon icon={faMapMarkerAlt} />{" "}
                <span style={{ fontSize: "18px" }}>
                  {municipalityorvdc}, {item.district}
                </span>{" "}
                <br />
