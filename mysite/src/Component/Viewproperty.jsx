          ...
          >
            ...
            >
              <h4 className="mt-3 mx-2 " style={{ color: "green" }}>
                {" "}
                <b>Room For Rent In Satbobato</b>
              </h4>
              <br />
              <h5 className="mx-4 mb-3">
                {" "}
                <b>Location: Satdobato</b>
              </h5>
              <h5 className="mx-4 mb-3">
                <b> Price: Rs 100000 </b>
              </h5>
            ...
            <div className="mt-5 mx-5">
              <Link to="/" className="btn btn-success  mb-1 me-3 ">
                Contact{" "}
              </Link>
        ...
        <div class="tab-content" id="nav-tabContent">
          ...
          >
            <p style={{ fontFamily: "sans-serif" }}>
              <h4>
                {" "}
                A house with 1 floor is built in an area of 3.1 aana is located
                at Suryabinayak, Bhaktapur, and is available for sale. <br />
                It is 1 km far from Arniko Highway, Suryabinayak Chowk. It has
                faced towards the south direction and has road access of 13
                feet. Located In Manjri B.K, Taluka Haveli,
                <br />
                These Semi/Fully-Equipped Co-Living Studios And 1 BHKs Feature
                All Basic Amenities And An Exclusive Game Room For Its
                Residents.
                <br />
                With Rent Starting At Just ₹5,500/ Bed, You Can Share Your Space
                With A Friend Or Live By Yourself. <br />
                Away From The Chaos Of Setting Up A House Or Paying A Huge Sum
                As Security Deposit, Enjoy The Perks Of Living In A Comfy Home.{" "}
              </h4>
            </p>
          </div>
          <div
          ...
          <div
            ...
            id="nav-comm"
            role="tabpanel"
            aria-labelledby="nav-condition-comment"
            tabindex="0"
          >
            <div>
              <div className="container mt-3 mb-3 contactContent">
                ...
                <div className="row mt-4">
                  <div
                    className="col-lg-4 mb-3 shadow"
