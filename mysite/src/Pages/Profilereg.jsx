...
export default function Profilereg() {
  ...
  const handleSubmit = async (event) => {
    ...
    if (firstname.length < 3 || lastname.length < 3 || age < 18 || age > 80) {
      setcheck(true);
      window.scrollTo(0, 0);
    }
    if (
            ...
            <form action="" method="post" onSubmit={handleSubmit}>
              <Grid container spacing={3}>
                <Grid item xs={12} sm={12}>
                  ...
                  />
                  {check && firstname.length < 3 && (
                    <ErrorMessage message="Firstname should be greater than 3 letters!" />
                  )}
                </Grid>
                ...
                <Grid item xs={12}>
                  <TextField
                    ...
                    variant="standard"
                  />
                  {check && lastname.length < 3 && (
                    <ErrorMessage message="Lastname should be greater than 3 letters!" />
                  )}
                </Grid>
                ...
                <Grid item xs={12} sm={6}>
                  <Form.Group controlId="dob">
                    ...
                    <Form.Control
                      ...
                      onChange={(event) => {
                        ...
                        calculate_age(event.target.value);
                      }}
                      required
                      fullWidth
                    />
                  ...
                  {check && (age < 18 || age > 80) && (
                    <ErrorMessage message="Incorrect DOB!!!" />
                  )}
                </Grid>
                ...
                <Grid item xs={12} sm={6}>
                  <TextField
                    ...
                    fullWidth
                    onChange={(event) =>
                      setmunicipalityorvdc(event.target.value)
                    }
                    variant="standard"
                  />
                </Grid>
