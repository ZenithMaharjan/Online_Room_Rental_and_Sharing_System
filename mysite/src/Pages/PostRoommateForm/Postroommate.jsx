...
function getStepContent(step) {
  ...
  const handlesubmit = async (event) => {
    ...
    try {
      ...
      const result = await axios.post(
        "http://localhost:5000/api/forms/addroommateform",
        form
      );
  ...
  switch (step) {
    case 0:
      return <Info property={propertyadd1} info={form} check={check} />;
    case 1:
      return <Preference property={propertyadd2} info={form} check={check} />;
    case 2:
      return (
        <>
          <Facility property={propertyadd3} info={form} check={check} />
          <Button
            type="submit"
            variant="contained"
